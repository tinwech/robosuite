...
class YCBArena(Arena):
    ...
    def __init__(
        ...
        # self.hammer_body = self.table_body.find("./body[@name='ycb-hammer']")
        # self.hammer_body.set("pos", array_to_string(self.center_pos))
        # self.hammer_visual = self.hammer_body.find("./geom[@name='hammer-visual']")
        # self.hammer_visual.set("pos", array_to_string([0, 0, 1]))
